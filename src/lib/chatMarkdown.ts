/**
 * Parser for the small markdown subset Money Brain is allowed to write (see
 * OUTPUT FORMAT in lib/ai/moneyBrainPrompt.ts): paragraphs, "- " and "1. "
 ...
 * Mobile/src/lib/chatMarkdown.ts; keep the two in sync.
 */
