...
const FAQS = [
  { q: 'Why give your money a job?', a: 'Your bank balance includes money for rent, groceries, future plans, and fun. Assigning it to envelopes shows which money is available for each purpose before you spend. Savings is a purpose too: you do not have to spend everything you assign.' },
  { q: 'Does zero ready to assign mean I’m out of money?', a: 'No. It means you have given all your available money a purpose. The money is still yours until you spend it. Check each envelope’s available balance to see what remains for that purpose.' },
  ...
  { q: 'Is Aviary free?', a: 'Aviary is on a trial plan while payments are still being set up, so it is free to use right now. You do not need a payment card to get started. Once payments go live, you will get a full 45-day trial from that point, and we will tell you before it starts. We have not settled on a price yet, but it will be kept affordable. Aviary is also open source; you can inspect the code on GitHub.' },
  ...
  { q: 'Can I use another currency?', a: 'Yes. Choose your display currency during setup or change it in More. One currency applies to your whole budget; changing it does not convert amounts.' },
]
...
export function LandingPage() {
  return <LandingMotion><div className="lp" id="top">
    ...
    <section className="lp-opening" aria-labelledby="landing-title">
      ...
      <div className="lp-opening-actions"><a className="lp-button lp-button--accent" href={PLAY_STORE}><Smartphone size={18} />Get it on Android</a><Link className="lp-button lp-button--outline" href="/expense"><Monitor size={18} />Open web app</Link><span>Your budget, your currency. Free &amp; open source.</span></div>
    </section>
